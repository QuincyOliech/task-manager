...
//                 <a href="#" className="block text-custom-blue p-2 border-2 border-custom-blue hover:text-white bg-white rounded-md hover-bg-custom-blue transition duration-300">
//                   Register
//                 </a>
//                 <a href="#" className="block text-custom-blue p-2 border-2 border-custom-blue hover:text-white bg-white rounded-md hover-bg-custom-blue transition duration-300">
//                   Login
...
//             <a href="#" className="text-custom-blue p-2 border-2 border-custom-blue hover:text-white bg-white rounded-md hover-bg-custom-blue transition duration-300">
//               Register
//             </a>
//             <a href="#" className="text-custom-blue p-2 border-2 border-custom-blue hover:text-white bg-white rounded-md hover-bg-custom-blue transition duration-300">
//               Login
